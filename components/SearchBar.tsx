...
export default function SearchBar({ onSearch, autoRedirect: _autoRedirect = false, compact = false, inputRef, onAfterNavigate, mobileMode = false, onClose }: SearchBarProps) {
